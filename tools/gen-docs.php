...
/**
 * Generates the static API reference site for milpa/live-tui.
 *
...
$config = new Milpa\Docs\SiteConfig(
    brand: 'Milpa Live TUI',
    nsPrefix: 'Milpa\\Live\\',
    installCommand: 'composer require milpa/live-tui',
    repoUrl: 'https://github.com/getmilpa/live-tui',
    pagesUrl: 'https://getmilpa.github.io/live-tui/',
